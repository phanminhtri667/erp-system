        ...
        <div className="sidebar-menu">
          ...
          <div className="menu-plus">
            <div className="menu-plus-wrap">
              <span>
                <p className="menu-item pointer ">
                  <FontAwesomeIcon icon={faAlgolia} className="menu-item-icon" />
                  Project
                </p>
                <p className="menu-item pointer ">
                  <FontAwesomeIcon icon={faHardDrive} className="menu-item-icon" />
                  Job Portal
                </p>
                <p className="menu-item pointer ">
            ...
            <div className="menu-plus-wrap">
              ...
              <span>
                <p className="menu-item pointer ">
                  <FontAwesomeIcon icon={faCopyright} className="menu-item-icon" />
                  Icon
                </p>
                <p className="menu-item pointer ">
                  <FontAwesomeIcon icon={faChartBar} rotation={270} className="menu-item-icon" />
                  Chart
                </p>
                <p className="menu-item pointer ">
                  <FontAwesomeIcon
