...
const EmployeeUpdate = ({ data, closeModal, getEmployee }: any) => {
  ...
  return (
    <div className="form">
      ...
      <div className="form-item">
        <InputField type="date" name="dob" placeholder="Date of birth" value={form.dob || ""} onChange={handleChange} />
      </div>
      <div className="form-item">
      ...
      <div className="form-item">
        <InputField name="bank_name" placeholder="Bank name" value={form.bank_info?.bank_name || ""} onChange={handleChange} />
      </div>
      <div className="form-item">
        <InputField name="account_no" placeholder="Account number" value={form.bank_info?.account_no || ""} onChange={handleChange} />
      </div>
